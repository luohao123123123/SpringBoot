...
import com.luohao.springboot.service.Mybatis_Student_Teacher_Service;
...
public class Mybatis_Student_Teacher_Controller {
    @Autowired
    Mybatis_Student_Teacher_Service mybatis_student_teacher_service;

    @ResponseBody
    @RequestMapping(value = "/getStudentsByTid/{tid}",method = RequestMethod.GET)
    public R getStudentsByTid(@PathVariable(value = "tid",required = false) int tid) {
    ...
    @ResponseBody
    @RequestMapping(value = "/getStudentsByTids",method = RequestMethod.GET)
    public R getStudentsByTids(@RequestParam(value = "tid",required = false) List<Integer> tid) {
    ...
    @ResponseBody
    @RequestMapping(value = "/getStudentsByLikeTeacherName/{name}",method = RequestMethod.GET)
    public R getStudentsByLikeTeacherName(@PathVariable(value = "name",required = false) String name) {
    ...
    public R getAllStudents(@PathVariable(value = "pageNum",required = false) int pageNum, @PathVariable(value = "pageSize",required = false) int pageSize){
